...
<body>
	...
	<div class="wrap">
		...
		<div  class=" well login">
			...
			<td style="border-top:0px;"> <input class="btn btn-info" type="submit" text-align: center; value="Login"></td>
			</tr>
			<tr>
			<td colspan="2" style="border-top:0px; text-align: center;"> <p>Don't have an Account?</p></td>
			</tr>
			<tr>
			<td style="border-top:0px;"></td>
			<td style="border-top:0px;"> <a class="btn btn-info" href="signup.php?value=0">Sign up</a></td>
			</tr>
