...
<body>
	...
	<div class="wrap">
		...
		<tr>
			...
			<td style="border-top:0px;"><input type="text" name="fname" class="input-block-level" placeholder="Enter the User name" onblur="return name1()"><span id="fn"></span></td>
		</tr>
		<tr>
			<td style="border-top:0px;"> Full Name <font color=red>* </font> </td>
			<td style="border-top:0px;"><input type="text" name="lname" class="input-block-level" placeholder="Enter the Full name" onblur="return name12()"><span id="ln"></span></td>
		</tr>
		<tr>
