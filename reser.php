		...
		<h2><font color="blue">Passenger Detail</font></h2>
			...
			<table class="table">
				...
				<tr>
                 ...
                 <td style="border-top:0px;"><input class="btn btn-info"type="submit" value="Pay Now" id="subb" onclick="myFunction()">
						<script>
								function myFunction() 
								{
									var response = confirm("Do you want to confirm the payment?");
									if (response == true) 
										{
